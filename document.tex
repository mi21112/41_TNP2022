...
\hspace*{1cm}Appcelerator je razvojni program za više platforme, kompatibilan za Windows, Android i iOS koji se oglašava kao " sve što vam je potrebno za kreiranje odličnih, izvornih aplikacija za mobilne uređaje - sve iz jedne osnove JavaScript koda ."
...
\begin{figure}[ht!]
    \centering
    \includegraphics[scale=0.8]{b4aslika.png}
...
\bibitem https://www.mindinventory.com/blog/unity-3d-game-development/
\bibitem https://unity.com/
\bibitem https://www.androidsis.com/bs/najbolji-alati-za-programere-android-aplikacija/#Otras_importantes_herramientas_para_desarrolladores_Android
\bibitem  https://bs.eyewated.com/top-5-alatki-za-razvoj-multiformnih-mobilnih-aplikacija/
\bibitem https://en.wikipedia.org/wiki/Android_software_development#Official_development_tools
